...
class Test1Controller: BaseController {
   ...
   private var timer:DispatchSourceTimer?
    ...
    override func drawRingClick(sender: UIButton){
        let testRing = TestRing1.init(frame: CGRect(x: 0, y: 0, width: 200, height: 200))
    ...
    //定时器1
    private func customTimerSource(testRing:TestRing1){
        //GCD创建定时器
    ...
    private func radianAnimationLoad(testRing:TestRing1){
