...
class Test2Controller: BaseController {
    ...
    override func drawRingClick(sender: UIButton){
        let testRing = TestRing2.init(frame: CGRect(x: 0, y: 0, width: 200, height: 200))
    ...
    //定时器1
    private func customTimerSource(testRing:TestRing2){
        //GCD创建定时器
    ...
    private func radianAnimationLoad(testRing:TestRing2){
