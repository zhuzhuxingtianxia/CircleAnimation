...
class Test9Controller: BaseController {
    ...
    override func drawRingClick(sender: UIButton){
        let testRing = TestRing9.init(frame: CGRect(x: 0, y: 0, width: 200, height: 200))
        testRing.center = view.center
        testRing.backgroundColor = UIColor.white
        testRing.lineW = 10
    ...
    //定时器1
    private func customTimerSource(testRing:TestRing9){
        //GCD创建定时器
    ...
    private func radianAnimationLoad(testRing:TestRing9){
